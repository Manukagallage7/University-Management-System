...
public class Marks extends JFrame implements ActionListener{
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("Delhi Techniacl University");
        ...
        try {
            ...
            ResultSet rs1 = c.s.executeQuery("select * from subjecct where rollno = '" + rollno + "'");
            while(rs1.next()){
            ...
            while(rs2.next()){
                ...
                sub5.setText(sub5.getText() + " : " + rs2.getString("marks4"));  
        ...
        cancel.setBounds(290, 500, 120, 25);
