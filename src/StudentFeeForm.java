...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        lblrollnumber.setBounds(40, 50, 150, 20);
        ...
        lblname.setBounds(40, 90, 150, 20);
        lblname.setFont(new Font("Tahoma", Font.BOLD, 16));
        add(lblname);

        JLabel labelname = new JLabel();
        labelname.setBounds(200, 90, 150, 20);
        labelname.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(labelname);

        JLabel lblfname = new JLabel("Father's Name");
        lblfname.setBounds(40, 130, 150, 20);
        ...
        cbcourse.setBounds(200, 180, 150, 18);
        ...
        cbbranch.setBounds(200, 220, 150, 18);
        ...
        cbsemester.setBounds(200, 260, 150, 18);
