...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lblempnumber = new JLabel("Select Employee Id");
        lblempnumber.setBounds(50, 100, 200, 20);
        lblempnumber.setFont(new Font("serif", Font.PLAIN, 20));
        add(lblempnumber);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {;
            ...
            try {
                String query = "UPDATE teacher SET address='" + address + 
                "', phone='" + phone + 
                "', email='" + email + 
                "', education='" + education + 
